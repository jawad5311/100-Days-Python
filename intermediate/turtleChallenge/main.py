...
def drawCircle(no_of_circles):
    heading = 0
    screen.colormode(255)

    while heading < no_of_circles + 1:
...
#     turtle.color(255, 245, 185)
#     print(turtle.colormode())
#     turtle.forward(30)
#     turtle.setheading(random.choice([0, 90, 180, 270]))


def turtleRandomWalk(turtle_range):
    heading = [0, 90, 180, 270]
    for _ in range(turtle_range):
        timmy.pencolor(randomColor())
        timmy.forward(25)
...
# def drawShape(start_sides, end_size):
#     end_size + 1
#
